...
import argparse
import configparser
from model.Crossgcn import make_model
...
parser.add_argument("--config", default='C:\\Users\\24600\\Desktop\\时空序列预测总结\\MultiGCN\\configurations\\PEMS08_Crossgcn.conf', type=str,
...
if __name__ == "__main__":
    ...
    predict_main(90, test_loader, test_target_tensor,metric_method, _mean, _std, 'test')
